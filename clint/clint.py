...
with socket.socket(socket.AF_INET , socket.SOCK_STREAM) as cs :
    ...
    def arrival_flight() :
        ...
        text_box=tk.Text(root , height=23 , width= 72  ,bg= '#BBAFA1',fg= 'black' ,  font=('Arial' , 15))
...
main_menu()
>>>>>>> af66a4ebfdc9e3cc43fd55ebc269258eccc8a73e
    ...
    #Enter client name
    Enter_name_label = tk.Label(root , text='ENTER YOUR NAME HERE ', font=('Arrial' , 15 )  , bg='#363030' , fg='white').place(x= 10 , y = 30   )

    name_as_string  =tk.StringVar()

    Enter_name_entry = tk.Entry(root , textvariable= name_as_string , width=25 , bg='#BBAFA1' , font = "Raleway"   ).place(x= 320 , y= 30  )

    #Enter icao
    Enter_icao_label = tk.Label(root  , text='ENTER AIRPORT CODE (ICAO) ' ,font=('Arrial' , 15) , bg='#363030' , fg= 'white').place(x =10 , y = 70  )

    icao_as_string = tk.StringVar()

    Enter_icao_entry = tk.Entry(root , textvariable= icao_as_string , width=25 , bg='#BBAFA1' ,font = "Raleway"  ).place(x= 320  ,y = 70 )

    #submit button
    submit_as_string = tk.StringVar()

    submit_button = tk.Button(root , textvariable= submit_as_string  ,command= information , font = "Arial" , bg = '#BBAFA1' , fg='black' , height=1 , width=15).place(x=650  , y = 45) 
    ...
    arrival_button = tk.Button(root  , textvariable = arrival_as_string , command= arrival_flight , font = "Arial " , bg = '#BBAFA1' , fg= 'black' , height= 2 , width= 34 )
    ...
    delayed_button = tk.Button(root  , textvariable = delayed_as_string , command = delayed , font = "Arial" , bg = '#BBAFA1' , fg= 'black' , height= 2 , width= 34 )
    ...
    flights_button = tk.Button(root  , textvariable = flights_as_string , command = lambda : main_menu('3')  ,  font = "Arial" , bg = '#BBAFA1' , fg= 'black' , height= 2 , width= 34 )
    ...
    #All data of particular flight
    flight_as_string = tk.StringVar()

    fligh_button_entry = tk.Button(root  , textvariable = flight_as_string, command= lambda : main_menu('4'), font = "Arial" , bg = '#BBAFA1' , fg= 'black' , height= 2 , width= 34 )

    flight_as_string.set('GET DETAILS OF PARTICULAR FLIGHT')
    ...
    quit_button = tk.Button(root  , text= 'QUIT THE PROGRAM' , command= quit  , font = "Arial" , bg = '#BBAFA1' , fg= 'black' , height= 2 , width= 34 )

    quit_button.place(y = 710 , x= 200)

    #frame
    fr = tk.Frame(root , bg='#BBAFA1' , highlightbackground="black", highlightthickness=3, height=538 , width=802).place(y = 198 , x= 697)
    ...
    def main_menu():
        ...
        def send_option(option) :
            ...
            if option == '3' :
                ...
                Enter_flight_label = tk.Label(root , text = 'ENTER CITY CODE HERE', font=('Arrial' , 15 )  , bg='#363030' , fg='white').place(x= 200 , y = 440   )
        
                Enter_flight_as_string =tk.StringVar()
                
                city_code_entry = tk.Entry(root , textvariable= Enter_flight_as_string , width=10, bg='#BBAFA1' , font = "Arial"  ).place(x= 200 , y= 480  )

                button_as_string = tk.StringVar()
                
                city_code_button = tk.Button(root , textvariable= button_as_string , command=City_info, font = "Arial" , bg = '#BBAFA1' , fg='black' , height=1 , width=15).place(x=370  , y = 480) 
                ...
                Enter_flight_label= tk.Label(root , text='ENTER FLIGHT CODE (ICAO)', font=('Arrial' , 15 )  , bg='#363030' , fg='white').place(x= 200 , y = 620   )
                
                Enter_flights_as_string  =tk.StringVar()
                
                Enter_slight_entry = tk.Entry(root , textvariable= Enter_flights_as_string , width=10 , bg='#BBAFA1' , font = "Arial"  ).place(x= 200 , y= 660  )

                flight_button_as_string = tk.StringVar()
                
                submit_city = tk.Button(root , textvariable= flight_button_as_string  , command= specific_flight , font = "Arial" , bg = '#BBAFA1' , fg='black' , height=1 , width=15).place(x=370  , y = 660) 
